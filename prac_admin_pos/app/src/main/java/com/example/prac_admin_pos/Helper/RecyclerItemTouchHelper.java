package com.example.prac_admin_pos.Helper;
...
public class RecyclerItemTouchHelper  extends ItemTouchHelper.SimpleCallback{
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if(viewHolder != null){
            if (this.listener.getClass().getSimpleName().equals("JobAppList")) {
                backgroundViewEdit = ((JobAppAdapter.MyViewHolder) viewHolder).viewBackgroundEdit;
                backgroundViewDelete = ((JobAppAdapter.MyViewHolder) viewHolder).viewBackgroundDelete;
                foregroundView = ((JobAppAdapter.MyViewHolder) viewHolder).viewForeground;
            }
